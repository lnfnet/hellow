...
#include <memory>
#include "../GUITestForCode/guitest.h"
...
void guiTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<guiTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject guiTest::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_guiTest.data,
    qt_meta_data_guiTest,
    qt_static_metacall,
    nullptr,
    nullptr
} };
