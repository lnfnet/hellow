...
qq::qq(QWidget *parent,Qt::WindowFlags f) : QToolBox(parent,f)
{
    ...
    toolBtn1_2 ->setIcon(QPixmap("11.png"));
    toolBtn1_2 ->setIconSize(QPixmap("11.png").size());
    toolBtn1_2 ->setAutoRaise(true);
    toolBtn1_2 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn1_3 = new QToolButton;
    toolBtn1_3 ->setText(tr("张三"));
    toolBtn1_3 ->setIcon(QPixmap("11.png"));
    toolBtn1_3 ->setIconSize(QPixmap("11.png").size());
    toolBtn1_3 ->setAutoRaise(true);
    toolBtn1_3 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn1_4 = new QToolButton;
    toolBtn1_4 ->setText(tr("张三"));
    toolBtn1_4 ->setIcon(QPixmap("11.png"));
    toolBtn1_4 ->setIconSize(QPixmap("11.png").size());
    toolBtn1_4 ->setAutoRaise(true);
    toolBtn1_4 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn1_5 = new QToolButton;
    toolBtn1_5 ->setText(tr("张三"));
    toolBtn1_5 ->setIcon(QPixmap("11.png"));
    toolBtn1_5 ->setIconSize(QPixmap("11.png").size());
    toolBtn1_5 ->setAutoRaise(true);
    toolBtn1_5 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn2_1 = new QToolButton;
    toolBtn2_1 ->setText(tr("张三"));
    toolBtn2_1 ->setIcon(QPixmap("11.png"));
    toolBtn2_1 ->setIconSize(QPixmap("11.png").size());
    toolBtn2_1 ->setAutoRaise(true);
    toolBtn2_1 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn2_2 = new QToolButton;
    toolBtn2_2 ->setText(tr("张三"));
    toolBtn2_2 ->setIcon(QPixmap("11.png"));
    toolBtn2_2 ->setIconSize(QPixmap("11.png").size());
    toolBtn2_2 ->setAutoRaise(true);
    toolBtn2_2 ->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);

    toolBtn3_1 = new QToolButton;
    toolBtn3_1 ->setText(tr("张三"));
    toolBtn3_1 ->setIcon(QPixmap("11.png"));
    toolBtn3_1 ->setIconSize(QPixmap("11.png").size());
    ...
    toolBtn3_2 ->setIcon(QPixmap("11.png"));
    toolBtn3_2 ->setIconSize(QPixmap("11.png").size());
    ...
    QVBoxLayout *layout3=new QVBoxLayout(groupBox3); //定义layout布司
    layout3->setMargin(10);
    layout3->setAlignment(Qt::AlignHCenter);
    layout3->addWidget(toolBtn3_1);
    layout3->addWidget(toolBtn3_2);

    this->addItem((QWidget*)groupBox1,tr("我的好友"));//在当前窗体加入三个组部件
